...
# Пороги срабатывания
PRICE_DROP_THRESHOLD = -1      # Падение цены от МАКСИМУМА за окно на -2.5% и ниже

# Условия: тренд и ОИ
MIN_OI_GROWTH_PCT = 5          # Рост открытого интереса от МИНИМУМА за окно на +2.5% и выше
REQUIRE_24H_DOWNTREND = True     # Требовать суточный нисходящий тренд (< 0%)
